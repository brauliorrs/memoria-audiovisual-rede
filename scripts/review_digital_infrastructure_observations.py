...
from memoria_audiovisual.digital_infrastructure.curatorial_review import CuratorialReviewService
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Opera a fila de revisão curatorial infraestrutura digital.")
    parser.add_argument("command", choices=("export", "import"))
    parser.add_argument("--ledger", type=Path, default=BASE_DIR / "data/digital_infrastructure/ledger.jsonl")
