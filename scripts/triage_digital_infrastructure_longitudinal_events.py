...
from memoria_audiovisual.digital_infrastructure.event_triage import triage_events


def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Classifica eventos longitudinais antes da publicação.")
    parser.add_argument("--snapshot-id", required=True)
    parser.add_argument("--coverage-dir", type=Path, default=BASE_DIR / "data/digital_infrastructure/coverage")
