...
from memoria_audiovisual.statetech.event_review import LongitudinalEventReviewService
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-root", type=Path, default=Path("data/statetech/public"))
