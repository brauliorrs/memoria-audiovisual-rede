...
from memoria_audiovisual.statetech.postflight import (
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Valida a coerência semântica da rodada Estado–tecnologia.")
