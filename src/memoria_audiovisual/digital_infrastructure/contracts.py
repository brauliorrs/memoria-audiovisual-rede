...
class SchemaRegistry:
    def __init__(self, repository_root: str | Path) -> None:
        ...
        # Compatibilidade de dados da Onda 1: o registro físico de schemas ainda
        # permanece no caminho histórico; sua migração requer gate próprio.
        registry_path = self.repository_root / "schemas/statetech/schema_registry.json"
