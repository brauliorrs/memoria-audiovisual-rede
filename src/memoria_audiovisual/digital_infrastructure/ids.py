...
def stable_id(entity_type: str, natural_key: str, *, namespace: str = "statetech") -> str:
    """Gera ID estável preservando o namespace lógico histórico.

    O default ``statetech`` é deliberado na Onda 1: mudar o caminho Python não
    pode alterar IDs já persistidos ou referências históricas.
    """
