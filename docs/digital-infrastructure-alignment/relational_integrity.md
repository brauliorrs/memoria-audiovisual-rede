# Integridade relacional da camada infraestrutura digital
...
- `data/output/digital_infrastructure_integrity_report.json`
- `data/output/digital_infrastructure_integrity_issues.csv`
