...
Todas as entidades da camada infraestrutura digital podem evoluir:
...
data/output/
├── digital_infrastructure_timeline.csv
├── digital_infrastructure_entity_history.json
├── digital_infrastructure_snapshot_manifest.json
└── digital_infrastructure_change_summary.csv
```
