...
Organizar os produtos previstos para a camada de infraestrutura e relações Estado–tecnologia, sem pressupor que todos serão disponibilizados na primeira versão pública.
