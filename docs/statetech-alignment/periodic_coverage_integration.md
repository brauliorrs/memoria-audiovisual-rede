# Integração da cobertura Estado–tecnologia ao ciclo periódico
...
A execução produzirá as observações no ledger, o relatório de cobertura e, havendo rodada anterior, o relatório de mudanças Estado–tecnologia.
