...
The core infrastructure and the first complete version of the Research Handbook have been implemented. The project is now in operational validation, with emphasis on automated quality checks, controlled real-world execution, manual evidence review, detector correction and verification of the scientific indicators.
